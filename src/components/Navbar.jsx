      ...
      <div className="navbar-container">
        ...
        <ul className={`nav-links ${isOpen ? 'open' : ''}`}>
          ...
          <li className="mobile-cta">
            <button className="talk-button" onClick={() => window.location.href = 'https://chat.lumidai.in'}>Talk to Lumid Ai</button>
          </li>
        </ul>

        <button className="talk-button desktop-only" onClick={() => window.location.href = 'https://chat.lumidai.in'}>Talk to Lumid Ai</button>
